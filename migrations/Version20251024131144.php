 ...
 */
final class Version20251024131144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO ouvrage (id, titre, auteurs, editeur, isbn, issn, categories, tags, langues, année, resume) SELECT id, titre, auteurs, editeur, isbn, issn, Categories, tags, langues, année, resume FROM __temp__ouvrage');
